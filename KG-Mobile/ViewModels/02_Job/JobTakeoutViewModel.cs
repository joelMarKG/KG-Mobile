...
namespace KG.Mobile.ViewModels._02_Job
{
    class JobTakeoutViewModel : INotifyPropertyChanged
    {
        private GraphQLApiServices _webApiServices = new GraphQLApiServices();
        private GraphQLApiServicesHelper _webApiServicesHelper = new GraphQLApiServicesHelper();
        ...
        public JobTakeoutViewModel(SoundHelper soundHelper)
        {
